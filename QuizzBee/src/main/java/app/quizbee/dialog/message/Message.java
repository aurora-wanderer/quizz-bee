...
public class Message extends javax.swing.JDialog {
    ...
    private TransparentPanel glass;
    ...
    private void init() {
        lbIcon.setIcon(SVGIcon.QUESTION_MESSAGE);
        ...
        setOpacity(0f);
        glass = new TransparentPanel();
        glass.setAlpha(0.5f);
        cmdOK.setBackground(Color.green);
    ...
    private void initComponents() {
        ...
        background1 = new app.quizbee.dialog.message.Background();
        cmdCancel = new app.quizbee.dialog.message.Button();
        cmdOK = new app.quizbee.dialog.message.Button();
    ...
    private app.quizbee.dialog.message.Background background1;
    private app.quizbee.dialog.message.Button cmdCancel;
    private app.quizbee.dialog.message.Button cmdOK;
